 ...
 * @param  TypeExtField 	键入扩展字段，允许您配置内存访问类型，例如强排序，外设。可以取值（0，1，2）
...
void Board_MPU_Config(uint8_t Region, MPU_Mode_t Mode, uint32_t Address, uint32_t Size)
{
    switch (Mode)
    {
    case MPU_Normal_WB:
